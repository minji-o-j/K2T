...
# python main.py -mode='next' -file_name=/data/50_keywordsets_eval/word_sets.txt -results_subfolder=tmp -weight=5.0 -top_p=0.9 -n_generated_sentences=90 -do_guarantee=True
